  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mt-4 p-3 bg-yellow-300 rounded-lg">
        ...
        <img className="h-10 w-10 rounded-full object-cover" src="https://64.media.tumblr.com/62f506fa5ba649dadd7547c2112286e8/tumblr_pl0gr4xpop1u24tvp_1280.jpg " alt="" />
      ...
      <div className="py-4">
        <div className="flex mt-5 items-center w-full justify-between">
        <button
            onClick={() => {
                props.setRidePopUPPanel(false);
              }}
          className="  bg-gray-300 font-semibold p-3 px-10 text-gray-700 rounded-lg "
        >
          Ignore
        </button>
        <button
          ...
          className="  bg-green-600 font-semibold p-3 px-10 text-white rounded-lg "
        >
          Accept Ride
        </button>
        </div>
